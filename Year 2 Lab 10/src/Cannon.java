...
public class Cannon {
	...
	// Compute the maximum range using angle 'angle' and initial velocity
	// 'muzzlevelocity'
	// 'angle' is in degrees and 'muzzlevelocity' is in metres per second
	// Returns maximum range as a Double in metres
	
	// this method simulates a K12 projectile being fired at a given angle and muzzle velocity in m/s
	// return value is horizontal range in metres
	public static Double GetMaxRange(Double angle, Double muzzlevelocity) {
		...
		//get your error checking out of here - I've already done it!
		if (t < 25)
			t = 25.0;
		if (t > 55)
			t = 55.0;
		...
		// lists for the velocity at each point in xi & yi
		...
		// Double vzero = new Double(1120.0); For Anzio Annie //what?
		// 'angle' no more than 50 degrees, not sure about minimum! //what?
	...
	// Compute air density
	// Returns a value between 0 and 1 (I think!!!) //you WHAT? 
	public static Double AirDensity(Double y) {
		...
		Double g = new Double(9.80665); // Gravity of the earth //what is everything else?
